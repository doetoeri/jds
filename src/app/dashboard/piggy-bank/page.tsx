      ...
      >
        <Card className="w-full max-w-md text-center">
          <CardHeader>
            ...
            >
              <PartyPopper className="h-20 w-20 mx-auto text-primary" />
            </motion.div>
            <CardTitle className="text-2xl font-bold font-headline mt-4">포인트 적립 완료!</CardTitle>
            <CardDescription>활동에 참여하여 포인트를 획득했습니다.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="p-4 bg-muted rounded-lg">
              <p className="text-sm text-muted-foreground">이번에 적립된 포인트</p>
